...
public class ExceptionApp1 {
	...
	public static void main(String[] args) {
		 ...
		 *     	}
		 *     
		 *      -try 블록의 수행문에서 예외클래스명1에 해당하는 예외가 발생하면 첫번째 catch 블록의 해당 예외를 가로채고 변수명1에 대입한다음,
		 *      예외처리수행문1을 실행한다.
		 *      -try 블록의 수행문에서 예외클래스명2에 해당하는 예외가 발생하면 두번째 catch 블록에서 해당 예외를 가로채곡 변수명2에 대입한 다음
		 *      예외처리수행문2을 실행한다.
